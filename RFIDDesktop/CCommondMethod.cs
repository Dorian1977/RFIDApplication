...
namespace RFIDApplication
{
    class CCommondMethod
    {
        ...
        /// <returns></returns>
        public static byte[] HEXStringToByteArray(string strHexValue)
        {
        ...
        /// <returns></returns>
        public static byte[] StringArray2ByteArray(string[] strAryHex, int nLen)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string[] String2StringArray(string strValue, int nLength)
        {
